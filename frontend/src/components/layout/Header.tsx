      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-18 py-3">
          <Link href="/" className="flex items-center gap-1.5 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0D85D8] to-[#0041C7] flex items-center justify-center shadow-[0_0_12px_rgba(13,133,216,0.4)] group-hover:scale-105 transition-transform">
